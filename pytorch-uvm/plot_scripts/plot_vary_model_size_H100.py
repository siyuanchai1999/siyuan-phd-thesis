...
def plot_H100_64K_opt_vary_model_size(gpu_memory_gib=80):
    """Plot total/prefill/decode time vs OPT model size on H100 (64K run).

    Kept under the old function name for backwards compatibility with any
    existing callers/imports, but this variant is configured for the H100
    sweep in ``.../huggingface/H100/vary_model_size/opt``.
    ...
    """
    folder = "../vary_batch_size/huggingface/H100/vary_model_size/opt"
    ...
    # model_sizes = ['6.7b', '13b', '30b', '66b', '175b']
    model_sizes = ['6.7b', '13b', '30b', '66b']

    ts = "20260423_205701"
    ts_no_uvm_devmap_auto = "20260424_120410"
    ...
    series = {
        "no_uvm_dynamic": {
            ...
            "color": PALETTE[0],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-no_uvm-dynamic-opt-{s}-prompt1920-{ts}.log"
                for s in model_sizes
            ],
        },
        "no_uvm_devmap_auto": {
            ...
            "color": PALETTE[1],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-no_uvm-dynamic-devmap_auto-opt-{s}-prompt1920-{ts_no_uvm_devmap_auto}.log"
                for s in model_sizes
            ],
        },
        "uvm_managed": {
            ...
            "color": PALETTE[2],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-uvm_managed-dynamic-opt-{s}-prompt1920-{ts}.log"
                for s in model_sizes
            ],
        },
        # "uvm_advise_prefetch": {
        ...
        #     "color": PALETTE[8],
        #     "log_template": [
        #         f"py313_pytorch_cuda13-cuda-default-customcaching--uvm_managed_advise_prefetch-dynamic-opt-{s}-prompt1920-{ts}.log"
        #         for s in model_sizes
        #     ],
        # },
        "uvm_advise_prefetch_discard": {
            ...
            "color": PALETTE[8],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-customcaching-discard=Standard-uvm_managed_advise_prefetch_discard-dynamic-opt-{s}-prompt1920-{ts}.log"
                for s in model_sizes
            ],
        },
    }
...
def plot_H100_64K_qwen_vary_model_size(gpu_memory_gib=80):
    """Plot total/prefill/decode time vs Qwen model size on H100 (64K run).

    Sibling of ``plot_H100_64K_opt_vary_model_size`` for the Qwen sweep
    ...
    """
    folder = "../vary_batch_size/huggingface/H100/vary_model_size/qwen"
    output_dir = f"{folder}/plots_64K"
    machine_type = "H100"
    prompt_len = 1920
    decode_len = 128
    ...
    ts = "20260424_001534"
    ts_no_uvm_devmap_auto = "20260424_113402"
    ...
    series = {
        "no_uvm_dynamic": {
            ...
            "color": PALETTE[0],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-no_uvm-dynamic-{m}-prompt1920-{ts}.log"
        ...
        "no_uvm_devmap_auto": {
            ...
            "color": PALETTE[1],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-no_uvm-dynamic-devmap_auto-{m}-prompt1920-{ts_no_uvm_devmap_auto}.log"
                for m in model_sizes
            ],
        },
        "uvm_managed": {
            ...
            "color": PALETTE[2],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-uvm_managed-dynamic-{m}-prompt1920-{ts}.log"
                for m in model_sizes
            ],
        },
        # "uvm_advise_prefetch": {
        ...
        #     "color": PALETTE[8],
        #     "log_template": [
        #         f"py313_pytorch_cuda13-cuda-default-customcaching--uvm_managed_advise_prefetch-dynamic-{m}-prompt1920-{ts}.log"
        #         for m in model_sizes
        #     ],
        # },
        "uvm_advise_prefetch_discard": {
            ...
            "color": PALETTE[8],
            "log_template": [
                f"py313_pytorch_cuda13-cuda-default-customcaching-discard=Standard-uvm_managed_advise_prefetch_discard-dynamic-{m}-prompt1920-{ts}.log"
                for m in model_sizes
            ],
        },
    }
    ...
    # caused it. See ``plot_H100_64K_opt_vary_model_size`` for the rationale.
...
if __name__ == '__main__':
    ...
    plot_H100_64K_opt_vary_model_size(gpu_memory_gib=80)
    plot_H100_64K_qwen_vary_model_size(gpu_memory_gib=80)
