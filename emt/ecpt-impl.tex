...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figs/emu.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.75\textwidth]{figs/pte-cluster.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.65\textwidth]{figs/paradox.pdf}
...
\begin{figure}[H]
	...
	\end{subfigure}%
	\vskip\baselineskip
	% (a) Micro benchmark: subcaption on top, small gap to the plot
	...
	\begin{subfigure}[b]{\columnwidth}
		...
		\captionsetup{justification=centering, aboveskip=0pt, belowskip=3pt}
		\caption{Macro benchmark}
		\includegraphics[width=0.45\textwidth]{data/radix.pdf}
		\label{emt:fig:eval:macrobenchmark}
	\end{subfigure}
	\caption{\bf Performance overhead of EMT-Linux over vanilla Linux (measured by the micro and macro benchmarks).}
	\label{emt:fig:eval:eval-stack-lebench}
