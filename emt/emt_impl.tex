...
\codenote{emtlock}{1ex}{2.6}{0.8}{right,yshift=1mm}{Customizable\\split PT lock.}
\codenote{emtiter}{0ex}{0.9}{-1.65}{right}{Customizable iterator can be\\implemented as \texttt{++} for performance.}
\codenote{emtptr}{0ex}{1.8}{-1.65}{right,yshift=-2.5mm}{EMT also allows in-place operations\\via low-level abstractions.}
\end{tikzpicture}
...
\begin{minted}[xleftmargin=20pt,tabsize=4,linenos,mathescape,breaklines,fontsize=\small]{C}
