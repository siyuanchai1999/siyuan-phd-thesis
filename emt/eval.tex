...
\begin{figure}[H]
	...
	\vskip\baselineskip
	\vspace{-20pt}
	% (a) Micro benchmark: subcaption placed below the plot.
	% The benchmarks are split across two stacked rows so the per-benchmark
	% x labels stay legible (see data/src/radix_lebench_split.ipynb).
	\begin{subfigure}[b]{\columnwidth}
		\centering
		\captionsetup{justification=centering, aboveskip=3pt, belowskip=0pt}
		\includegraphics[width=0.9\textwidth]{data/radix_lebench_1.pdf}\\[3pt]
		\includegraphics[width=0.9\textwidth]{data/radix_lebench_2.pdf}
		\caption{Micro benchmark}
		\label{emt:fig:eval:microbenchmark}
	\end{subfigure}
	\vskip\baselineskip
	% (b) Macro benchmark: stacked vertically below, subcaption on top
	\begin{subfigure}[b]{\columnwidth}
		\centering
		\captionsetup{justification=centering, aboveskip=0pt, belowskip=3pt}
		\includegraphics[width=0.5\textwidth]{data/radix.pdf}
