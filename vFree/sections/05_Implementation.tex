...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{figures/nginx_size_sweep.pdf}
        \caption{NGINX}
        \label{vfree:fig:nginx}
    \end{subfigure}
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{figures/redis_value_sweep.pdf}
        \caption{Redis}
        \label{vfree:fig:redis}
    \end{subfigure}
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{figures/spdk_fio_block_sizes.pdf}
        \caption{SPDK}
