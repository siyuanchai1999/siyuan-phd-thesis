...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/eval_core_exp-tput.pdf}
        \caption{Throughput}
        \label{vfree:fig:eval-core-tput}
    \end{subfigure}
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/eval_core_exp-qi_submit_sync-count_per_page.pdf}
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/eval_core_exp-cache_tag_flush_range-mean_ns.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/tx-ebpf-tput.pdf}
        \caption{Throughput}
        \label{vfree:fig:tx-tput}
    \end{subfigure}
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/tx-ebpf-qi_submit_sync-count_per_page.pdf}
        \caption{IR-SUB count per page}
        \label{vfree:fig:tx-qi}
    \end{subfigure}
    \begin{subfigure}[b]{\columnwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{figures/tx-ebpf-cache_tag_flush_range-mean_ns.pdf}
        \caption{IR processing latency per unmap}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.75\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/eval_ablation_tx-tput.pdf}
        \caption{Tx-server}
        \label{vfree:fig:ablation-tx}
    \end{subfigure}
    \begin{subfigure}[b]{0.75\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/eval_ablation_rx-tput.pdf}
        \caption{Rx-server}
